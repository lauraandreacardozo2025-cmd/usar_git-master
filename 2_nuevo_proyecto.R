...
# ------------------------------------------------------------------------------
# PASO 1: EL ESCUDO DE DATOS SENSIBLES (.gitignore) este nos permite subir archivos q podran ser ignorados 
 # ------------------------------------------------------------------------------
...
use_git_ignore(c(
  ".Renviron",        # Variables de entorno/credenciales locales (no mandes lo siguiente )

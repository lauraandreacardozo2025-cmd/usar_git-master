...
# dir.create("datos/primarios", recursive = TRUE)
...
# una base real)
base_original <- as.data.table(iris)
fwrite(base_original, here("datos", "primarios", "iris.csv"))

# "Procesamos" algo mínimo y guardamos el resultado en /procesados (que es una carpeta dentro de la carpeta datos)
